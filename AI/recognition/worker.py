...
class worker(object):
    def __init__(self, config, inference=False):
        ...
        (
            ...
            img_list, label, test_size=config.validate_ratio
        )
    ...
    def eval(self):
        ...
        for it in range(iteration):
            data, labels = dataLoaderWithLabel(
                self.test_img, self.test_label, len(self.test_img), it, self.batch_size
            )
            ...
            testX, testY = Variable(testX).to("cpu"), Variable(testY).to("cpu")
    ...
    def train(self, config):
        ...
        for epoch in range(self.max_epochs):
            ...
            for it in range(it_train):
                ...
                trainX, trainY = Variable(trainX).to("cpu"), Variable(trainY).to("cpu")
